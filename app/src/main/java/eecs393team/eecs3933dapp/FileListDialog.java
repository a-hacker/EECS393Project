    ...
    public void show(String path) {
        ...
        try {
            ...
            if (dialogFileList == null) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(context).setTitle(title).setItems(list.toArray(new String[] {}), this).setOnKeyListener(this).setNeutralButton(R.string.close_dialog, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // finish the dialog
                        listener.onClickFileList(null);
